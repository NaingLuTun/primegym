...
const Program = () => {
    ...
    return (
        <div className={`${isLargeScreen? "p-[40px] h-[400px]": isMediumScreen? "p-[20px] h-[600px]" : "p-[20px] h-[900px]"} bg-[#232429]  mt-[200px] relative program-container`}>
            <div className={` grid justify-center items-center ${isLargeScreen? "p-[40px] grid-cols-3 gap-[40px]" : isMediumScreen? "p-[40px] grid-cols-2 gap-[40px]" : "p-[20px] grid-cols-1 gap-[20px]"} w-full h-fit absolute -top-[160px] left-1/2 -translate-x-1/2`}>
                <div className={`${isLargeScreen? "p-[40px]" : "p-[20px]"} flex flex-col justify-center items-center bg-[#e9e9e9] h-[270px] body-building-program`}>
                    <img src={bodyBuildingIcon} alt="body building" className={`w-[60px]`} />
                    <h2 className={`${isLargeScreen? "text-[20px]" : "text-[18px]"} mt-3 mb-3 font-[600]`}>BODY BUILDING</h2>
                ...
                <div className={`${isLargeScreen? "p-[40px]" : "p-[20px]"} flex flex-col justify-center items-center bg-[#e9e9e9] h-[270px] muscle-building-program`}>
                    <img src={muscleBuildingIcon} alt="muscle building" className={`w-[60px]`} />
                    <h2 className={`${isLargeScreen? "text-[20px]" : "text-[18px]"} mt-3 mb-3 font-[600]`}>MUSCLE BUILDING</h2>
                    <p className="text-[#727272] mb-3 text-center">
                ...
                <div className={`${isLargeScreen? "p-[40px]" : "p-[20px]"} flex flex-col justify-center items-center bg-[#e9e9e9] h-[270px] weight-lifting-program`}>
                    <img src={weightLiftingIcon} alt="weight lifting" className={`w-[60px]`} />
                    <h2 className={`${isLargeScreen? "text-[20px]" : "text-[18px]"} mt-3 mb-3 font-[600]`}>WEIGHT LIFTING</h2>
                    <p className="text-[#727272] mb-3 text-center">
                ...
                <div className={`${isLargeScreen? "col-start-2 col-span-1" : ""} flex flex-col items-center gap-[20px] program-discount-container`}>
                    <h2 className="text-white text-center text-[25px] font-[700]">
